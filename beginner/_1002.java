 ...
 * exemplo abaixo, com 4
 * casas após o ponto decimal. Utilize variáveis de dupla precisão (double).
 * Como todos os problemas,
 * não esqueça de imprimir o fim de linha após o resultado, caso contrário, você
